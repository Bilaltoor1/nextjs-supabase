        ...
        <div className="relative flex items-center space-x-4">
            ...
            >
                ...
                <svg
                    ...
                    className={cn(
                        ...
                        { "scale-100": colorTheme === "dark" },
                        { "scale-0": colorTheme === "light" }
                    )}
                >
                    <path
                ...
                <svg
                    ...
                    className={cn(
                        ...
                        { "scale-0": colorTheme === "dark" },
                        { "scale-100": colorTheme === "light" }
                    )}
                >
                    <path
                ...
                <span
                    className={cn(
                        ...
                        { "translate-x-[2.625rem]": colorTheme === "dark" }
                    )}
                >
          <svg
              width="24"
              ...
              className={cn(
                  ...
                  { "scale-0 opacity-0": colorTheme === "dark" },
                  { "scale-100 opacity-100": colorTheme === "light" }
              )}
          >
            <path
                d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
          ...
          <svg
              ...
              className={cn(
                  ...
                  { "scale-100 opacity-100": colorTheme === "dark" },
                  { "scale-0 opacity-0": colorTheme === "light" }
              )}
          >
            <path
                d="M18 15.63c-.977.52-1.945.481-3.13.481A6.981 6.981 0 0 1 7.89 9.13c0-1.185-.04-2.153.481-3.13C6.166 7.174 5 9.347 5 12.018A6.981 6.981 0 0 0 11.982 19c2.67 0 4.844-1.166 6.018-3.37ZM16 5c0 2.08-.96 4-3 4 2.04 0 3 .92 3 3 0-2.08.96-3 3-3-2.04 0-3-1.92-3-4Z"
