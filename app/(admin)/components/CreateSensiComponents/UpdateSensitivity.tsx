...
export default  function UpdateSensitivity({dfval} : any) {
    const [img, setImg] = useState(dfval.thumbnail_url)
    const [mobileIcon, setMobileIcon] = useState(dfval.mobile_icon_url)
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            device_name: dfval.device_name || "",
            rom: dfval.rom || "",
            ram: dfval.ram || "",
            screen_resolution: dfval.screen_resolution || "",
            slug: dfval.slug || "",
            intro: dfval.intro || false,
            camera: dfval.camera || false,
            ads: dfval.ads || false,
            gyroScope: dfval.gyroScope || false,
            explanation: dfval.explanation || "",
            claws: dfval.claws || false,
            intro_text: dfval.intro_text || "",
            proccessor: dfval.proccessor || "",

            // this is for table of sensitivities
            tpp_no_scope: dfval.sensitivities[0].tpp_no_scope || "",
            fpp_no_scope: dfval.sensitivities[0].fpp_no_scope || "",
            red_dot: dfval.sensitivities[0].red_dot || "",
            "2x_scope": dfval.sensitivities[0]["2x_scope"] || "",
            '3x_scope': dfval.sensitivities[0]["3x_scope"] || "",
            '4x_scope': dfval.sensitivities[0]["4x_scope"] || "",
            '6x_scope': dfval.sensitivities[0]["6x_scope"] || "",
            '8x_scope': dfval.sensitivities[0]["8x_scope"] || "",
            ads_tpp_no_scope: dfval.sensitivities[0].ads_tpp_no_scope || "",
            ads_fpp_no_scope: dfval.sensitivities[0].ads_fpp_no_scope || "",
            ads_red_dot: dfval.sensitivities[0].ads_red_dot || "",
            ads_2x: dfval.sensitivities[0].ads_2x || "",
            ads_3x: dfval.sensitivities[0].ads_3x || "",
            ads_4x: dfval.sensitivities[0].ads_4x || "",
            ads_6x: dfval.sensitivities[0].ads_6x || "",
            ads_8x: dfval.sensitivities[0].ads_8x || "",
            gyro_tpp_no_scope: dfval.sensitivities[0].gyro_tpp_no_scope || "",
            gyro_fpp_no_scope: dfval.sensitivities[0].gyro_fpp_no_scope || "",
            gyro_red_dot: dfval.sensitivities[0].gyro_tpp_red_dot || "",
            gyro_2x: dfval.sensitivities[0].gyro_2x || "",
            gyro_3x: dfval.sensitivities[0].gyro_3x || "",
            gyro_4x: dfval.sensitivities[0].gyro_4x || "",
            gyro_6x: dfval.sensitivities[0].gyro_6x || "",
            gyro_8x: dfval.sensitivities[0].gyro_8x || "",
            freelook_camera_tpp: dfval.sensitivities[0].freelook_camera_tpp || "",
            freelook_camera_parachuting: dfval.sensitivities[0].freelook_camera_parachuting || "",
            freelook_camera_fpp_character: dfval.sensitivities[0].freelook_camera_fpp_character || ""
        }
    })
            ...
            <Form {...form}>
                <form className="space-y-8">
                            ...
                            <FormItem className="flex lg:w-full w-full flex-col gap-3">
                                ...
                                <FormControl className="mt-3.5">
                                    <Editor
                                        ...
                                        initialValue={dfval.explanation}
                                        init={{
                                            height: 500,
                                            menubar: false,
                                            plugins: [
                    ...
                    <Button onClick={form.handleSubmit(onSubmit)}
                            className='bg-black text-white dark:bg-light-850 dark:text-dark-100'>Update Sensitivity</Button>
                </form>
            </Form>
        </div>
    )
