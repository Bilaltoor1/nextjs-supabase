...
export default function UpdateGameEditor({dfval}: any) {
    const [thumbnail, setThumbnail] = useState(dfval.thumbnail)
    const [screenShot, setScreenShot] = useState<any>([])
    const [screenShotUrl, setScreenShotUrl] = useState<any>(dfval.screenshots)
    const [appIcon, setAppIcon] = useState(dfval.app_game_icon)
    ...
    const form = useForm<z.infer<typeof GamesAndAppsValidation>>({
        ...
        defaultValues: {
            download_link: dfval.download_link,
            name: dfval.name,
            slug: dfval.slug,
            // @ts-ignore
            app_game_size: dfval.size,
            apps_game_version: dfval.version,
            category: dfval.category,
            sub_category: dfval.sub_category,
            description: dfval.description,
        },
    })
