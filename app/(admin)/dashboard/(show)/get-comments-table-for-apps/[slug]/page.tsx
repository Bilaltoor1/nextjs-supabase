                    ...
                    <Table className='w-full overflow-x-scroll rounded border'>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className='w-[150px] text-dark300_light700 text-center'>User
                                    Image</TableHead>
                                <TableHead
                                    className='w-[100px] text-dark300_light700 text-center'>is_Published</TableHead>
                                            ...
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <Button variant="ghost"
                                                            className="h-8 w-8 p-0 text-dark300_light700">
