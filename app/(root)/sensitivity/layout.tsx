...
function SensitivityLayout({children}: { children: React.ReactNode }) {
    return (
        <main className="background-light850_dark100 relative">
            <Navbar/>
            <div className="flex">
                <Sidebar/>
                <section className="flex min-h-screen w-full flex-1 flex-col px-4 pb-6 pt-36 max-md:pb-14 sm:px-14">
...
export default SensitivityLayout;